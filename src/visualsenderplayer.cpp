...
VisualSenderPlayerV19::VisualSenderPlayerV19( const Params & params )
    : VisualSenderPlayerV18( params )
{

}

VisualSenderPlayerV19::~VisualSenderPlayerV19()
{

}

void
VisualSenderPlayerV19::sendHighFlag( const PObject & flag )
{
    const double ang = calcRadDir( flag );
...
void
VisualSenderPlayerV19::sendHighBall( const MPObject & ball )
{
    const double ang = calcRadDir( ball );
...
void
VisualSenderPlayerV19::sendHighPlayer( const Player & player )
{
    const double ang = calcRadDir( player );
...
double
VisualSenderPlayerV19::calcGaussianDist( const double actual_dist,
...
double 
VisualSenderPlayerV19::calcGaussianChangeDist( const double actual_dist_change,
...
double 
VisualSenderPlayerV19::calcGaussianChangeDir( const double actual_dir_change,
                                              const double actual_dist,
                                              const double focus_dist,
                                              const double noise_rate,
                                              const double focus_noise_rate) const
...
void
VisualSenderPlayerV19::calcGaussianVel( const PVector & obj_vel,
                                        const PVector & obj_pos,
                                        const double & actual_dist,
                                        const double & focus_dist,
                                        double& dist_chg,
...
RegHolder vp19 = VisualSenderPlayer::factory().autoReg( &create< VisualSenderPlayerV19 >, 19 );
}
